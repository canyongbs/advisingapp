...
class ListUsers extends ListRecords
{
        ...
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('teams')
                    ...
                    ->getSearchResultsUsing(fn (string $search) => $this->getTeamSearch($search))
    ...
    public function getTeamSearch($search): array
    {
        $teams = Team::query()->where('name', 'like', '%' . $search . '%')->take(50)->pluck('name', 'id')->toArray();
