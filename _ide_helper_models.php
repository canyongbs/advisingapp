...
namespace App\Models{
    use Illuminate\Support\Carbon;
    use Spatie\Health\Models\TFactory;
...
namespace App\Models{
    use Illuminate\Database\Eloquent\Collection;
    use Spatie\ScheduleMonitor\Models\TFactory;
...
namespace App\Models{
    use Illuminate\Support\Carbon;
    use Spatie\Multitenancy\Models\TFactory;
...
namespace AdvisingApp\Application\Models{
    ...
    use AdvisingApp\Form\Models\TFactory;
    use Illuminate\Database\Eloquent\Collection;
    use Illuminate\Support\Carbon;
