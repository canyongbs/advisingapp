...
namespace App\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read Model|\Eloquent $prospects
     * @property-read Model|\Eloquent $students
...
namespace App\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property CarbonImmutable|null $last_chat_ping_at
     ...
     * @property-read Collection<int, AiAssistantUpvote> $aiAssistantUpvotes
     * @property-read int|null $ai_assistant_upvotes_count
     * @property-read Collection<int, AiThreadFolder> $aiThreadFolders
     * @property-read int|null $ai_thread_folders_count
     * @property-read Collection<int, AiThread> $aiThreads
     ...
     * @property-read Collection<int, CaseAssignment> $caseAssignments
     * @property-read int|null $case_assignments_count
     * @property-read TeamUser|Subscription|CareTeam|UserConsentAgreement|null $pivot
     ...
     * @property-read Collection<int, TrackedEvent> $logins
     * @property-read int|null $logins_count
     * @property-read Collection<int, TrackedEventCount> $loginsCount
     ...
     * @property-read Collection|Alert[] $studentAlerts
     * @property-read int|null $student_alerts_count
     * @property-read Collection|Alert[] $prospectAlerts
     ...
     * @property-read Collection|CaseModel[] $cases
...
namespace AdvisingApp\Ai\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property AiApplication $application
     * @property bool $is_default
     * @property AiModel $model
     * @property Carbon|null $archived_at
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, AiAssistantFile> $files
     * @property-read int|null $files_count
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
     * @property-read Collection<int, AiThread> $threads
     * @property-read int|null $threads_count
     * @property-read Collection<int, AiAssistantUpvote> $upvotes
...
namespace AdvisingApp\Ai\Models{
     ...
     * @property-read Collection<int, AiMessageFile> $files
     * @property-read int|null $files_count
...
namespace AdvisingApp\Ai\Models{
     ...
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
     * @property-read AiMessage $message
     *
...
namespace AdvisingApp\Ai\Models{
     ...
     * @property-read CarbonInterface|null $last_engaged_at
     * @property-read Collection<int, AiMessage> $messages
     * @property-read int|null $messages_count
     * @property-read User $user
     * @property-read AiMessage|null $pivot
...
namespace AdvisingApp\Ai\Models{
     ...
     * @property AiFeature|null $feature
     * @property-read User $user
     *
...
namespace AdvisingApp\Ai\Models{
     ...
     * @property-read Collection<int, PromptUpvote> $upvotes
     * @property-read int|null $upvotes_count
     * @property-read User|null $user
     * @property-read Collection<int, PromptUse> $uses
...
namespace AdvisingApp\Alert\Models{
     ...
     * @property-read AlertStatus $status
     *
...
namespace AdvisingApp\Alert\Models{
     ...
     *
     * @property string $id
     * @property SystemAlertStatusClassification $classification
     * @property string $name
     * @property int $order
     * @property bool $is_default
     * @property Carbon|null $created_at
...
namespace AdvisingApp\Application\Models{
     ...
     * @property-read Collection<int, ApplicationField> $fields
     * @property-read int|null $fields_count
     * @property-read ApplicationSubmissionState $state
     * @property-read Application $submissible
     *
...
namespace AdvisingApp\Application\Models{
     ...
     *
     * @property string $id
     * @property ApplicationSubmissionStateClassification $classification
     * @property string $name
     * @property ApplicationSubmissionStateColorOptions $color
     * @property string $description
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
...
namespace AdvisingApp\BasicNeeds\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, BasicNeedsProgram> $basicNeedsProgram
...
namespace AdvisingApp\BasicNeeds\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read BasicNeedsCategory $basicNeedsCategories
     *
...
namespace AdvisingApp\CareTeam\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read Educatable $educatable
     * @property-read User $user
     *
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property string|null $deleted_at
     * @property-read Collection<int, CaseFormField> $fields
     * @property-read int|null $fields_count
     * @property-read Collection<int, CaseFormStep> $steps
     * @property-read int|null $steps_count
     * @property-read Collection<int, CaseFormSubmission> $submissions
     * @property-read int|null $submissions_count
     * @property-read CaseType|null $type
     *
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property-read Model|\Eloquent|null $author
     * @property-read CaseForm $submissible
     *
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read CaseForm|null $step
     * @property-read CaseForm $submissible
     *
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property-read Collection<int, CaseFormField> $fields
     * @property-read int|null $fields_count
     * @property-read CaseForm|null $submissible
     *
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property string|null $deleted_at
     * @property-read CaseModel|null $case
     * @property-read Collection<int, CaseFormField> $fields
     * @property-read int|null $fields_count
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read CaseAssignment|null $assignedTo
     * @property-read Collection<int, CaseAssignment> $assignments
     * @property-read int|null $assignments_count
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read CaseFormSubmission|null $caseFormSubmission
     ...
     * @property-read Collection<int, CaseHistory> $histories
     * @property-read int|null $histories_count
     * @property-read CaseAssignment|null $initialAssignment
     * @property-read Collection<int, Interaction> $interactions
     * @property-read int|null $interactions_count
     * @property-read CaseUpdate|null $latestInboundCaseUpdate
     * @property-read CaseUpdate|null $latestOutboundCaseUpdate
     * @property-read Collection<int, Interaction> $orderedInteractions
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     *
     * @property string $id
     * @property SystemCaseClassification $classification
     * @property string $name
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property-read Collection<int, CaseModel> $cases
     * @property-read int|null $cases_count
     * @property-read CaseForm|null $form
     * @property-read Collection<int, CasePriority> $priorities
...
namespace AdvisingApp\CaseManagement\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, CasePriority> $casePriorities
...
namespace AdvisingApp\Consent\Models{
     ...
     * @property-read UserConsentAgreement|null $pivot
     * @property-read Collection<int, User> $users
     * @property-read int|null $users_count
     *
...
namespace AdvisingApp\Engagement\Models{
     ...
     * @property-read SmsMessage|null $latestSmsMessage
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
...
namespace AdvisingApp\Form\Models{
     ...
     * @property-read FormEmailAutoReply|null $emailAutoReply
...
namespace AdvisingApp\Form\Models{
     ...
     * @property-read Form $submissible
     * @property-read FormFieldSubmission|null $pivot
     * @property-read Collection<int, FormSubmission> $submissions
     * @property-read int|null $submissions_count
     *
...
namespace AdvisingApp\Interaction\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read InteractionConfidentialUser|InteractionConfidentialTeam|null $pivot
     ...
     * @property-read InteractionInitiative|null $initiative
     * @property-read Model|\Eloquent|null $interactable
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     * @property string $user_id
     * @property Carbon|null $oauth_token_expires_at
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read Collection<int, CalendarEvent> $events
     * @property-read int|null $events_count
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     * @property-read EventRegistrationForm|null $eventRegistrationForm
     *
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     *
     * @property string $id
     * @property EventAttendeeStatus $status
     ...
     * @property-read Collection<int, Student> $students
     * @property-read int|null $students_count
     * @property-read Collection<int, EventRegistrationFormSubmission> $submissions
     * @property-read int|null $submissions_count
     *
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     * @property Carbon|null $deleted_at
     * @property-read Event $event
     * @property-read Collection<int, EventRegistrationFormField> $fields
     * @property-read int|null $fields_count
     * @property-read mixed $name
     * @property-read Collection<int, EventRegistrationFormStep> $steps
     * @property-read int|null $steps_count
     * @property-read Collection<int, EventRegistrationFormSubmission> $submissions
     * @property-read int|null $submissions_count
     *
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read EventAttendee $author
     *
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read EventRegistrationFormStep|null $step
     * @property-read EventRegistrationForm $submissible
     *
...
namespace AdvisingApp\MeetingCenter\Models{
     ...
     * @property string $form_id
     * @property string $event_attendee_id
     * @property EventAttendeeStatus $attendee_status
     * @property CarbonImmutable|null $submitted_at
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property string|null $deleted_at
     * @property FormSubmissionRequestDeliveryMethod $request_method
     * @property-read EventAttendee $author
     * @property-read Collection<int, EventRegistrationFormField> $fields
     * @property-read int|null $fields_count
     * @property-read User|null $requester
...
namespace AdvisingApp\Notification\Models{
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read Collection<int, SmsMessageEvent> $events
     * @property-read int|null $events_count
     * @property-read Model|\Eloquent|null $recipient
     * @property-read Model|\Eloquent|null $related
     *
...
namespace AdvisingApp\Notification\Models{
     ...
     * @property SmsMessageEventType $type
     * @property array<array-key, mixed> $payload
     * @property Carbon $occurred_at
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property-read SmsMessage|null $message
     *
...
namespace AdvisingApp\Prospect\Models{
     ...
     * @property-read EducatablePipelineStage|null $pivot
     * @property-read Collection<int, Prospect> $educatablePipelineStages
...
namespace AdvisingApp\Prospect\Models{
     ...
     * @property-read Collection<int, ProspectAddress> $addresses
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, BasicNeedsProgram> $basicNeedsPrograms
     * @property-read int|null $basic_needs_programs_count
     * @property-read Taggable|Subscription|EngagementFileEntities|EducatablePipelineStage|CareTeam|null $pivot
     * @property-read Collection<int, User> $careTeam
     * @property-read int|null $care_team_count
     * @property-read Collection<int, CaseModel> $cases
     * @property-read int|null $cases_count
     * @property-read User|null $createdBy
     * @property-read Collection<int, Pipeline> $educatablePipelineStages
     * @property-read int|null $educatable_pipeline_stages_count
     * @property-read Collection<int, ProspectEmailAddress> $emailAddresses
     ...
     * @property-read Collection<int, Engagement> $engagements
     * @property-read int|null $engagements_count
     * @property-read Collection<int, EventAttendee> $eventAttendeeRecords
     ...
     * @property-read Collection<int, Interaction> $orderedInteractions
     * @property-read int|null $ordered_interactions_count
     * @property-read Collection<int, ProspectPhoneNumber> $phoneNumbers
     * @property-read int|null $phone_numbers_count
     * @property-read ProspectAddress|null $primaryAddress
     * @property-read ProspectEmailAddress|null $primaryEmail
     * @property-read ProspectPhoneNumber|null $primaryPhone
     ...
     * @property-read Collection<int, PersonalAccessToken> $tokens
     * @property-read int|null $tokens_count
     * @property-read Collection|AlertHistory[] $alertHistories
     * @property-read int|null $alert_histories_count
     * @property-read Collection|TaskHistory[] $taskHistories
...
namespace AdvisingApp\Prospect\Models{
     ...
     * @property-read Prospect $prospect
     *
...
namespace AdvisingApp\ResourceHub\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read ResourceHubCategory|null $category
     * @property-read Collection<int, Division> $division
     * @property-read int|null $division_count
     * @property-read MediaCollection<int, Media> $media
     * @property-read int|null $media_count
     * @property-read ResourceHubQuality|null $quality
     * @property-read ResourceHubStatus|null $status
     * @property-read Collection<int, ResourceHubArticleUpvote> $upvotes
     * @property-read int|null $upvotes_count
     * @property-read Collection<int, ResourceHubArticleView> $views
...
namespace AdvisingApp\ResourceHub\Models{
     ...
     * @property Carbon|null $updated_at
     * @property string|null $deleted_at
     * @property-read ResourceHubArticle $resourceHubArticle
     * @property-read User $user
     *
...
namespace AdvisingApp\ResourceHub\Models{
     ...
     * @property-read Collection<int, Audit> $audits
     * @property-read int|null $audits_count
     * @property-read Collection<int, ResourceHubArticle> $resourceHubArticles
...
namespace AdvisingApp\Segment\Models{
     ...
     * @property-read Collection<int, SegmentSubject> $subjects
...
namespace AdvisingApp\StudentDataModel\Models{
     ...
     * @property Carbon|null $last_upd_dt_stmp
...
namespace AdvisingApp\StudentDataModel\Models{
     ...
     * @property Carbon|null $change_dt
     * @property Carbon|null $declare_dt
     * @property Carbon|null $graduation_dt
     * @property Carbon|null $conferred_dt
     * @property-read Student|null $student
     *
...
namespace AdvisingApp\StudentDataModel\Models{
     ...
     * @property Carbon|null $updated_at_source
     * @property Carbon|null $deleted_at
     * @property string|null $primary_email_id
     * @property string|null $primary_phone_id
     * @property string|null $primary_address_id
     * @property-read Collection<int, StudentAddress> $addresses
     * @property-read int|null $addresses_count
     * @property-read Collection<int, Alert> $alerts
     * @property-read int|null $alerts_count
     * @property-read Collection<int, ApplicationSubmission> $applicationSubmissions
     ...
     * @property-read Collection<int, BasicNeedsProgram> $basicNeedsPrograms
     * @property-read int|null $basic_needs_programs_count
     * @property-read Taggable|Subscription|EngagementFileEntities|CareTeam|null $pivot
     * @property-read Collection<int, User> $careTeam
     * @property-read int|null $care_team_count
     * @property-read Collection<int, CaseModel> $cases
     * @property-read int|null $cases_count
     * @property-read Collection<int, StudentEmailAddress> $emailAddresses
     * @property-read int|null $email_addresses_count
     * @property-read Collection<int, EngagementFile> $engagementFiles
     * @property-read int|null $engagement_files_count
     * @property-read Collection<int, EngagementResponse> $engagementResponses
     ...
     * @property-read Collection<int, Interaction> $orderedInteractions
     * @property-read int|null $ordered_interactions_count
     * @property-read Collection<int, StudentPhoneNumber> $phoneNumbers
     * @property-read int|null $phone_numbers_count
     * @property-read StudentAddress|null $primaryAddress
     * @property-read StudentEmailAddress|null $primaryEmail
     * @property-read StudentPhoneNumber|null $primaryPhone
     * @property-read Collection<int, Program> $programs
     * @property-read int|null $programs_count
     * @property-read Collection<int, Prospect> $prospects
     * @property-read int|null $prospects_count
     * @property-read Collection<int, SegmentSubject> $segmentSubjects
...
namespace AdvisingApp\Survey\Models{
     ...
     * @property-read int|null $fields_count
     * @property-read Collection<int, SurveyStep> $steps
     * @property-read int|null $steps_count
     * @property-read Collection<int, SurveySubmission> $submissions
     * @property-read int|null $submissions_count
     *
...
namespace AdvisingApp\Survey\Models{
     ...
     * @property Carbon|null $updated_at
     * @property-read Model|\Eloquent|null $author
     * @property-read Survey $submissible
     *
...
namespace AdvisingApp\Survey\Models{
     ...
     * @property Carbon|null $updated_at
     * @property Carbon|null $deleted_at
     * @property-read SurveyStep|null $step
     * @property-read Survey $submissible
     * @property-read SurveyFieldSubmission|null $pivot
     * @property-read Collection<int, SurveySubmission> $submissions
     * @property-read int|null $submissions_count
     *
...
namespace AdvisingApp\Task\Models{
     ...
     * @property-read int|null $audits_count
     * @property-read User|null $createdBy
     * @property-read Collection<int, TaskHistory> $histories
     * @property-read int|null $histories_count
     *
