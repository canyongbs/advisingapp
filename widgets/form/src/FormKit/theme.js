...
export default {
    ...
    'family:button': {
        input: '$reset inline-flex items-center bg-primary-500 text-white text-sm font-medium py-2 px-3 rounded cursor-pointer focus-visible:outline-2 focus-visible:outline-primary-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-disabled:cursor-not-allowed formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin hover:bg-primary-600',
        wrapper: 'mb-1',
