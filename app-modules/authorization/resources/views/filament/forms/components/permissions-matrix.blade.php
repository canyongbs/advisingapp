...
>
    @if (!$isDisabled)
            ...
            <div class="divide-gray-950/5 dark:divide-white/10 lg:flex lg:divide-x lg:divide-y-0">
                <div
                    ...
                    <div class="divide-gray-950/5 dark:divide-white/10 lg:flex lg:divide-x lg:divide-y-0">
                        ...
                        <div
                            class="hidden divide-x divide-gray-950/5 text-sm dark:divide-white/10 lg:grid lg:grid-cols-6 lg:gap-0">
                            <div
                                class="hidden divide-x divide-gray-950/5 text-sm dark:divide-white/10 lg:grid lg:grid-cols-6 lg:gap-0">
                                @foreach ([
        'view-any' => 'View',
        ...
        'restore' => 'Restore',
                                    ...
                                    <div
                                        class="flex items-center justify-center px-3 py-2 text-gray-950 dark:text-white lg:w-28">
                                        'view-any' => 'View',
                                        'create' => 'Create',
                                        'update' => 'Update',
                                        'delete' => 'Delete',
