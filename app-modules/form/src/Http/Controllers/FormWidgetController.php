...
class FormWidgetController extends Controller
{
    ...
    public function requestAuthentication(Request $request, ResolveSubmissionAuthorFromEmail $resolveSubmissionAuthorFromEmail, AuthenticationCodeRateLimiter $rateLimiter, Form $form): JsonResponse
    {
        ...
        $scope = 'form:' . $form->getKey();

        $rateLimiter->ensureCanRequestCode($author, $scope);

        FormAuthentication::query()
    ...
    public function authenticate(Request $request, GenerateFormKitSchema $generateSchema, Form $form, FormAuthentication $authentication): JsonResponse
    {
        ...
        return response()->json([
            ...
            'allow_view_past_submissions' => $form->allow_view_past_submissions,
