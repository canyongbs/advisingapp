...
class EducatablePreferredNameFormFieldBlock extends FormFieldBlock
{
    public ?string $label = 'Preferred Name';
    ...
    {
        return 'educatable_preferred_name';
    }
    ...
    {
        return ['string', 'max:255', 'nullable'];
    }
}
