...
<div class="mb-3 flex gap-4 text-base md:gap-6">
    ...
    <div class="prose flex-1 dark:prose-invert">
        <p
            x-data="{ message: @js('Hi ' . auth()->user()->name . ', I am happy to help you draft this message. Please describe what you would like the proposed message to say:'), position: 0 }"
            x-init="
