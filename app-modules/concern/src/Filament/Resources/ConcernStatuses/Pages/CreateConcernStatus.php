...
namespace AdvisingApp\Concern\Filament\Resources\ConcernStatuses\Pages;
...
class CreateConcernStatus extends CreateRecord
{
            ...
            ->components([
                ...
                Toggle::make('is_default')
                    ...
                    ->hint(function (?ConcernStatus $record, bool $state): ?string {
                        ...
                        $currentDefault = ConcernStatus::query()
