...
/**
 * @mixin IdeHelperResourceHubStatus
 */
class ResourceHubStatus extends BaseModel implements Auditable
{
    use SoftDeletes;
    use AuditableTrait;
    use HasUuids;
    ...
    {
        return ResourceHub::active() ? 'resource_hub_statuses' : 'knowledge_base_statuses';
    }
