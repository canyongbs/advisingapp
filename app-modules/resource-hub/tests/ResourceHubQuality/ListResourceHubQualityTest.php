...
test('ListResourceHubQuality is gated with proper access control', function () {
...
test('ListResourceHubQuality is gated with proper license access control', function () {
    $settings = app(LicenseSettings::class);
