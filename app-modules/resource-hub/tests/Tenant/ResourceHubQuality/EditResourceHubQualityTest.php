...
//
//test('EditResourceHubQuality requires valid data', function ($data, $errors) {})->with([]);

// Permission Tests

test('EditResourceHubQuality is gated with proper access control', function () {
    ...
    actingAs($user)
        ->get(
            ResourceHubQualityResource::getUrl('edit', [
                'record' => $resourceHubQuality,
            ])
        )->assertForbidden();
