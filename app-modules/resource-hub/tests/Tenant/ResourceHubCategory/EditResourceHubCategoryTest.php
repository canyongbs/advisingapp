...
//
//test('EditResourceHubCategory requires valid data', function ($data, $errors) {})->with([]);

// Permission Tests

test('EditResourceHubCategory is gated with proper access control', function () {
    ...
    actingAs($user)
        ->get(
            ResourceHubCategoryResource::getUrl('edit', [
                'record' => $resourceHubCategory,
            ])
        )->assertForbidden();
