...
test('ListResourceHubStatuses is gated with proper access control', function () {
...
test('ListResourceHubStatus is gated with proper license access control', function () {
    $settings = app(LicenseSettings::class);
