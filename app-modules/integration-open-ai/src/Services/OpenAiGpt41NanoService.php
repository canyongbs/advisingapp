...
class OpenAiGpt41NanoService extends BaseOpenAiService implements AiServiceLifecycleHooks
{
    use UploadsFiles;
    ...
    public function __construct(
        ...
        $this->client = OpenAI::factory()
            ...
            ->withHttpHeader('api-key', $this->settings->open_ai_gpt_41_nano_api_key ?? config('integration-open-ai.gpt_41_nano_api_key'))
            ->withQueryParam('api-version', config('integration-open-ai.gpt_41_nano_api_version'))
    ...
    {
        return $this->settings->open_ai_gpt_o1_nano_api_key ?? config('integration-open-ai.gpt_41_nano_api_key');
    }
