...
class OpenAiGpt41MiniService extends BaseOpenAiService implements AiServiceLifecycleHooks
{
    use UploadsFiles;
    ...
    public function __construct(
        ...
        $this->client = OpenAI::factory()
            ...
            ->withHttpHeader('api-key', $this->settings->open_ai_gpt_41_mini_api_key ?? config('integration-open-ai.gpt_41_mini_api_key'))
            ->withQueryParam('api-version', config('integration-open-ai.gpt_41_mini_api_version'))
