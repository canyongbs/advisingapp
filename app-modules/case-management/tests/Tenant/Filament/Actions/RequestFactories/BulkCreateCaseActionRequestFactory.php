...
class BulkCreateCaseActionRequestFactory extends RequestFactory
{
    public function definition(): array
    {
        ...
        return [
            'division_id' => Division::factory()->create()->getKey(),
            'status_id' => CaseStatus::factory()->create()->getKey(),
            'type_id' => $priority->type_id,
            'priority_id' => $priority->getKey(),
            'close_details' => $this->faker->sentence,
            'res_details' => $this->faker->sentence,
            'assigned_to_id' => User::factory()->for(Department::factory()->hasAttached($priority->type, relationship: 'manageableCaseTypes')),
        ];
    }
}
