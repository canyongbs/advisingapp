...
class ServiceRequestAssignmentPolicy
{
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["service_request_assignment.{$serviceRequestAssignment->id}.view"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["service_request_assignment.{$serviceRequestAssignment->id}.update"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["service_request_assignment.{$serviceRequestAssignment->id}.delete"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["service_request_assignment.{$serviceRequestAssignment->id}.restore"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["service_request_assignment.{$serviceRequestAssignment->id}.force-delete"],
