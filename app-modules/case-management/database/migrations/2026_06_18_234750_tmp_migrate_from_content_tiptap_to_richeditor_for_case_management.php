...
return new class () extends Migration {
    ...
    {
        $this->processTable('case_forms', 'content');
        $this->processTable('case_form_steps', 'content');

        $this->processTable('case_type_email_templates', 'subject');
        $this->processTable('case_type_email_templates', 'body');
    }
