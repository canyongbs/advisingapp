...
/**
 * @extends Factory<CaseTypeEmailTemplate>
 */
class CaseTypeEmailTemplateFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'type' => $this->faker->randomElement(collect(CaseEmailTemplateType::cases())->values()->toArray()),
            ...
            'role' => fn (array $attributes) => $attributes['type'] === CaseEmailTemplateType::SurveyResponse
              ? CaseTypeEmailTemplateRole::Customer
              : $this->faker->randomElement(CaseTypeEmailTemplateRole::cases()),
        ];
    }
}
