    ...
    public function mutateFormDataBeforeFill(array $data): array
    {
        ...
        if ($bookingPage) {
            return [
                ...
                'working_hours' => PersonalBookingAvailabilityFeature::active() ? (! empty($user->working_hours) ? DailyHoursRepeater::mutateDataBeforeFill($user->working_hours) : DailyHoursRepeater::defaultValue()) : $user->working_hours,
                ...
                'office_hours' => PersonalBookingAvailabilityFeature::active() ? (! empty($user->office_hours) ? DailyHoursRepeater::mutateDataBeforeFill($user->office_hours) : DailyHoursRepeater::defaultValue()) : $user->office_hours,
