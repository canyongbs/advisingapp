...
<x-filament-panels::page>
    ...
    @else
        <div
            ...
            x-data="customerAdvisorPreview({
                        csrfToken: @js(csrf_token()),
                        sendMessageUrl: @js(URL::to(URL::signedRoute('widgets.ai.customer-advisors.api.messages.send', ['advisor' => $this->getRecord(), 'preview' => true]))),
        ...
        @vite(['app-modules/ai/resources/js/customer-advisor-preview.js'])
    @endif
</x-filament-panels::page>
