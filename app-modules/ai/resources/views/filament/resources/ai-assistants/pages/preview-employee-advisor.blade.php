            ...
            >
                ...
                >
                    <div class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
                        <x-filament::button class="w-full sm:w-auto" type="submit" x-bind:disabled="isSendingMessage">
                            Send
                        </x-filament::button>
                    ...
                    <div x-show="error" class="mt-2 text-sm text-danger-600 sm:mt-0" x-text="error"></div>
                </div>
            </div>
        </form>
    </div>

    @vite(['app-modules/ai/resources/js/employee-advisor-preview.js'])
</x-filament-panels::page>
