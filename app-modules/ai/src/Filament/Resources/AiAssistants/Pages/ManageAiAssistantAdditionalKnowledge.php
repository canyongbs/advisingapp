                ...
                Section::make('Additional Knowledge')
                    ...
                    ->schema([
                        Repeater::make('files')
                            ...
                            ->addable(false)
                            ->visible(fn (AiAssistant $record): bool => $record->files->isNotEmpty())
                            ->deleteAction(
                        ...
                        FileUpload::make('uploaded_files')
                            ...
                            ->multiple()
                            ->reactive()
                            ->maxFiles(fn (AiAssistant $record): int => 25 - $record->files->count())
                            ->disabled(fn (AiAssistant $record): bool => $record->files->count() >= 25)
