...
class CustomerAdvisorQuestionExporter extends Exporter
{
    public const EXPORT_NAME = 'Customer Chatbot Questions';

    protected static ?string $model = CustomerAdvisorQuestion::class;
