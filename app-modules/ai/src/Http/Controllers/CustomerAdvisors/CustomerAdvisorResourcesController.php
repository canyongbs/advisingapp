...
class CustomerAdvisorResourcesController
{
    public function __invoke(Request $request, CustomerAdvisor $advisor): JsonResponse
    {
        ...
        $manifestPath = public_path('storage/widgets/ai/customer-advisors/.vite/manifest.json');
        ...
        return response()->json([
            'asset_url' => route('widgets.ai.customer-advisors.asset'),
            'entry' => route('widgets.ai.customer-advisors.api.entry', ['advisor' => $advisor]),
            'js' => route('widgets.ai.customer-advisors.asset', ['file' => $widgetEntry['file']]),
        ]);
    }
}
