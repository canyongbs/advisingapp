...
class EmployeeAdvisorQuestionPolicy
{
    ...
    public function viewAny(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to view Employee Advisor Questions.'
        );
    }
    ...
    public function view(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to view this Employee Advisor Question.'
        );
    }
    ...
    public function create(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to create Employee Advisor Questions.'
        );
    }
    ...
    public function update(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to update this Employee Advisor Question.'
        );
    }
    ...
    public function delete(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to delete this Employee Advisor Question.'
        );
    }
    ...
    public function restore(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to restore this Employee Advisor Question.'
        );
    }
