...
class EmployeeAdvisorCategoryPolicy
{
    ...
    public function viewAny(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to view Employee Advisor Categories.'
        );
    }
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['assistant_custom.*.view'],
            denyResponse: 'You do not have permission to view this Employee Advisor Category.'
        );
    }
    ...
    public function create(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to create Employee Advisor Categories.'
        );
    }
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ['assistant_custom.*.update'],
            denyResponse: 'You do not have permission to update this Employee Advisor Category.'
        );
    }
    ...
    public function delete(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to delete this Employee Advisor Category.'
        );
    }
    ...
    public function restore(Authenticatable $authenticatable): Response
    {
        return $authenticatable->canOrElse(
            ...
            denyResponse: 'You do not have permission to restore this Employee Advisor Category.'
        );
    }
