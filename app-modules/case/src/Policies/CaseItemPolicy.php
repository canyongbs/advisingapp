...
class CaseItemPolicy
{
    ...
    public function view(User $user, CaseItem $caseItem): Response
    {
    ...
    public function update(User $user, CaseItem $caseItem): Response
    {
    ...
    public function delete(User $user, CaseItem $caseItem): Response
    {
    ...
    public function restore(User $user, CaseItem $caseItem): Response
    {
    ...
    public function forceDelete(User $user, CaseItem $caseItem): Response
    {
