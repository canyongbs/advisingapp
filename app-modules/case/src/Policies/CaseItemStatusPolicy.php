...
class CaseItemStatusPolicy
{
    ...
    public function view(User $user, CaseItemStatus $caseItemStatus): Response
    {
    ...
    public function update(User $user, CaseItemStatus $caseItemStatus): Response
    {
    ...
    public function delete(User $user, CaseItemStatus $caseItemStatus): Response
    {
    ...
    public function restore(User $user, CaseItemStatus $caseItemStatus): Response
    {
    ...
    public function forceDelete(User $user, CaseItemStatus $caseItemStatus): Response
    {
