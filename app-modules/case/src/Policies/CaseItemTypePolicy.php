...
class CaseItemTypePolicy
{
    ...
    public function view(User $user, CaseItemType $caseItemType): Response
    {
    ...
    public function update(User $user, CaseItemType $caseItemType): Response
    {
    ...
    public function delete(User $user, CaseItemType $caseItemType): Response
    {
    ...
    public function restore(User $user, CaseItemType $caseItemType): Response
    {
    ...
    public function forceDelete(User $user, CaseItemType $caseItemType): Response
    {
