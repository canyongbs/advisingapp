...
{
    protected ?string $heading = 'Prospects (Engagement)';
    ...
    public function getData(): array
    {
        ...
        $runningTotalPerMonth = $shouldBypassCache
           ? $this->getProspectEngagementData($startDate, $endDate, $groupId)
     ...
     */
    protected function getProspectEngagementData(?Carbon $startDate = null, ?Carbon $endDate = null, ?string $groupId = null): array
    {
