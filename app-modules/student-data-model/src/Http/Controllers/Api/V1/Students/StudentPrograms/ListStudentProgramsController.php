...
class ListStudentProgramsController
{
    ...
    #[QueryParameter('filter[change_dt]', description: 'Filter the results where the program\'s Change Date matches the provided date using comparison operators. Supported: =, <, <=, >, >=. Format: YYYY-MM-DD.', type: 'date')]
    #[QueryParameter('filter[declare_dt]', description: 'Filter the results where the program\'s Declare Date matches the provided date using comparison operators. Supported: =, <, <=, >, >=. Format: YYYY-MM-DD.', type: 'date')]
