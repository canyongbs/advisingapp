...
it('can filter students by all attributes', function (string $requestKey, mixed $requestValue, array $includedAttributes, array $excludedAttributes, string $responseKey, mixed $responseValue) {
    ...
    '`f_e_term`' => ['f_e_term', '2025FA', ['f_e_term' => '2025FA'], ['f_e_term' => 'UNIQUE_TERM'], 'f_e_term', '2025FA'],
    '`mr_e_term`' => ['mr_e_term', '2025SP', ['mr_e_term' => '2025SP'], ['mr_e_term' => 'UNIQUE_TERM2'], 'mr_e_term', '2025SP'],
...
dataset('sorts', [
    ...
    '`f_e_term`' => ['f_e_term', ['f_e_term' => 'A'], ['f_e_term' => 'B'], 'f_e_term', 'A', 'B'],
    '`mr_e_term`' => ['mr_e_term', ['mr_e_term' => 'A'], ['mr_e_term' => 'B'], 'mr_e_term', 'A', 'B'],
