...
class CourseWithdrawalPresetHandler implements AlertPresetHandler
{
    public function getName(): string
    {
        return 'Course Withdrawal';
    }

    public function getDescription(): string
    {
        return 'This alert is turned on when a student withdraws from at least one course in any semester. It is intended to surface students who may be facing academic, personal, or scheduling challenges that lead them to drop a class.';
    }
