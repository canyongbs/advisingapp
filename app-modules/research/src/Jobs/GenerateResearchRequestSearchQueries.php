...
class GenerateResearchRequestSearchQueries implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $searchQueries = $settings->discovery_model
            ->getService()
            ->structured(
        ...
        if (blank($searchQueries)) {
            $this->fail('No search queries were generated by the AI service.');
        ...
        if (count($searchQueries) < $numberOfSearchQueries) {
            $this->fail('Not enough search queries were generated by the AI service.');
        ...
        $this->batch()->add(array_map(
            fn (array $searchQueryData): FetchResearchRequestSearchQueryParsingResults => app(FetchResearchRequestSearchQueryParsingResults::class, [
                'researchRequest' => $this->researchRequest,
                'searchQuery' => $searchQueryData['query'],
            ]),
            $searchQueries,
        ));
    }
