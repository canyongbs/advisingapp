...
/**
 * @mixin IdeHelperWorkflowProactiveConcernDetails
 */
class WorkflowProactiveConcernDetails extends WorkflowDetails implements Auditable
{
    use SoftDeletes;
    use AuditableTrait;
    use HasUuids;

    protected $table = 'workflow_proactive_alert_details';
