...
class ProactiveConcernWorkflowActionJob extends ExecuteWorkflowActionJob
{
    ...
    public function handle(): void
    {
        try {
            ...
            assert($details instanceof WorkflowProactiveConcernDetails);
            ...
            $workflowRunStepRelated->related()->associate($concern);
