...
class AuditPolicy
{
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["audit.{$audit->getKey()}.view"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["audit.{$audit->getKey()}.update"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["audit.{$audit->getKey()}.delete"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["audit.{$audit->getKey()}.restore"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["audit.{$audit->getKey()}.force-delete"],
