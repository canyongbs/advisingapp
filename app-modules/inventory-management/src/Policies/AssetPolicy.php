...
class AssetPolicy
{
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["asset.{$asset->id}.update"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["asset.{$asset->id}.delete"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["asset.{$asset->id}.restore"],
    ...
    {
        return $authenticatable->canOrElse(
            abilities: ["asset.{$asset->id}.force-delete"],
