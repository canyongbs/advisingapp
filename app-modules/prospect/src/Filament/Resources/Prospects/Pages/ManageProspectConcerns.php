...
class ManageProspectConcerns extends ManageRelatedRecords
{
    ...
    public static function getNavigationItems(array $urlParameters = []): array
    {
        ...
        $concernsCount = Cache::tags('{concern-count}')
            ->remember(
                "concern-count-{$ownerRecord->getKey()}",
                now()->addMinutes(5),
        ...
        $item->badge((fn () => $concernsCount > 0 ? $concernsCount : null), color: 'danger');
            ...
            ->headerActions([
                CreateAction::make()
                    ->authorize(function () {
                        ...
                        return auth()->user()->can('create', [Concern::class, $ownerRecord instanceof Prospect ? $ownerRecord : null]);
                    })
