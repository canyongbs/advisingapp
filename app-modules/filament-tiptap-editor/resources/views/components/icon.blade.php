...
>
    @switch($icon)
        ...
        @case('grid-builder')
            <path
                fill="currentColor"
                d="M3 21h8v-8H3m2 2h4v4H5m-2-8h8V3H3m2 2h4v4H5m8-6v8h8V3m-2 6h-4V5h4m-1 11h3v2h-3v3h-2v-3h-3v-2h3v-3h2Z"
            />
        @break
        ...
        @case('hurdle')
            <path
                fill="currentColor"
                d="M2 3h6v2H4v14h4v2H2V3m5 14v-2h2v2H7m4 0v-2h2v2h-2m4 0v-2h2v2h-2m7-14v18h-6v-2h4V5h-4V3h6Z"
            />
        @break
