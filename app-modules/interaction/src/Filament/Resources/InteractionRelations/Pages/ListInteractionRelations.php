...
namespace AdvisingApp\Interaction\Filament\Resources\InteractionRelations\Pages;
...
class ListInteractionRelations extends ListRecords
{
    ...
    protected string $view = 'interaction::filament.pages.list-interaction-relations';
    ...
    public function fillForm(): void
    {
        ...
        $data = [
            'is_relation_enabled' => $settings->is_relation_enabled,
            'is_relation_required' => $settings->is_relation_required,
        ];
