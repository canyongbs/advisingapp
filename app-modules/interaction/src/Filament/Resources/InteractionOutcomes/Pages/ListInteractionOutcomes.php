...
namespace AdvisingApp\Interaction\Filament\Resources\InteractionOutcomes\Pages;
...
class ListInteractionOutcomes extends ListRecords
{
    ...
    protected string $view = 'interaction::filament.pages.list-interaction-outcomes';
