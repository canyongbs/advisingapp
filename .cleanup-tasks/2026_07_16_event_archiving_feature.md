...
- In `app-modules/meeting-center/src/Filament/Resources/Events/Pages/ViewEvent.php`:
    1. In `getHeaderActions()` function remove the ternary operation and only keep `ArchiveAction::make()`.
