...
<x-filament::fieldset>
    <x-slot name="label">Tags</x-slot>

    <dl class="max-w-md divide-y divide-gray-200 text-gray-900 dark:divide-gray-700 dark:text-white">
        <div class="flex flex-col pb-3">
            <dt class="mb-1 text-sm text-gray-500 dark:text-gray-400">
                Tags to be assigned to the {{ $group->model }}
            </dt>
        ...
        <div class="flex flex-col pb-3">
            <dt class="mb-1 text-sm text-gray-500 dark:text-gray-400">
                Remove all prior {{ $group->model }} assignments
            </dt>
