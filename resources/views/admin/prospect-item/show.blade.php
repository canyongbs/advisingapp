                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        class="link-light-blue"
                                        href="mailto:{{ $prospectItem->email_2 }}"
                                    >
                                        <i class="far fa-envelope fa-fw">
                                        </i>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($prospectItem->status)
                                        <span
                                            class="badge badge-relationship">{{ $prospectItem->status->status ?? '' }}</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    @if ($prospectItem->source)
                                        <span
                                            class="badge badge-relationship">{{ $prospectItem->source->source ?? '' }}</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($prospectItem->assignedTo)
                                        <span
                                            class="badge badge-relationship">{{ $prospectItem->assignedTo->name ?? '' }}</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    @if ($prospectItem->createdBy)
                                        <span
                                            class="badge badge-relationship">{{ $prospectItem->createdBy->name ?? '' }}</span>
                                    @endif
                                </td>
                            </tr>
                        </tbody>
