    ...
    <div class="card bg-blueGray-100">
        ...
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($caseItem->priority)
                                    <span class="badge badge-relationship">{{ $caseItem->priority->priority ?? '' }}</span>
                                @endif
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($caseItem->createdBy)
                                    <span class="badge badge-relationship">{{ $caseItem->createdBy->name ?? '' }}</span>
                                @endif
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="form-group">
                @can('case_item_edit')
                    <a href="{{ route('admin.case-items.edit', $caseItem) }}" class="btn btn-indigo mr-2">
                        {{ trans('global.edit') }}
                    </a>
                @endcan
