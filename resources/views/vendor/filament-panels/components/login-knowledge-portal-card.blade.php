...
<div class="bg-turkish-300 text-white rounded-xl p-6">
    <div class="flex md:flex-row flex-col justify-center items-center gap-6">
        <div>
            ...
            <a href="{{ $productKnowledgebaseUrl }}" class="border-2 border-gray-700 px-4 py-2 text-gray-700 rounded-xl text-sm font-semibold inline-block">Visit Knowledge Portal</a>
        </div>
        <img src="{{ Vite::asset('resources/images/portal_image.svg') }}" class="block max-h-32" />
    </div>
</div>
