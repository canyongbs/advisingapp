                                ...
                                <div class="flex justify-end">
                                    @can('prospect_status_show')
                                        <a
                                            ...
                                            href="{{ route('admin.prospect-statuses.show', $prospectStatus) }}"
                                        >
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('prospect_status_edit')
                                        <a
                                            ...
                                            href="{{ route('admin.prospect-statuses.edit', $prospectStatus) }}"
                                        >
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('prospect_status_delete')
                                        <button
                                            ...
                                            type="button"
                                            wire:click="confirm('delete', {{ $prospectStatus->id }})"
                                            wire:loading.attr="disabled"
                                        >
                                            {{ trans('global.delete') }}
                                        </button>
