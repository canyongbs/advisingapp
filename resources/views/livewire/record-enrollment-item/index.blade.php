                                ...
                                <div class="flex justify-end">
                                    @can('record_enrollment_item_show')
                                        <a
                                            ...
                                            href="{{ route('admin.record-enrollment-items.show', $recordEnrollmentItem) }}"
                                        >
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('record_enrollment_item_edit')
                                        <a
                                            ...
                                            href="{{ route('admin.record-enrollment-items.edit', $recordEnrollmentItem) }}"
                                        >
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('record_enrollment_item_delete')
                                        <button
                                            ...
                                            type="button"
                                            wire:click="confirm('delete', {{ $recordEnrollmentItem->id }})"
                                            wire:loading.attr="disabled"
                                        >
                                            {{ trans('global.delete') }}
                                        </button>
