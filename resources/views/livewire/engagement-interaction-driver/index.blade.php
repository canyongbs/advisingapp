        ...
        <div class="w-full sm:w-1/2">
            ...
            @if (file_exists(app_path('Http/Livewire/ExcelExport.php')))
                <livewire:excel-export
                    format="csv"
                    model="EngagementInteractionDriver"
                />
                <livewire:excel-export
                    format="xlsx"
                    model="EngagementInteractionDriver"
                    ...
                    @forelse($engagementInteractionDrivers as $engagementInteractionDriver)
                        <tr>
                            <td>
                                <input
                                    type="checkbox"
                                    value="{{ $engagementInteractionDriver->id }}"
                                ...
                                <div class="flex justify-end">
                                    @can('engagement_interaction_driver_show')
                                        <a
                                            ...
                                            href="{{ route('admin.engagement-interaction-drivers.show', $engagementInteractionDriver) }}"
                                        >
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('engagement_interaction_driver_delete')
                                        <button
                                            ...
                                            type="button"
                                            wire:click="confirm('delete', {{ $engagementInteractionDriver->id }})"
                                            wire:loading.attr="disabled"
                                        >
                                            {{ trans('global.delete') }}
                                        </button>
