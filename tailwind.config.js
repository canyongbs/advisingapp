...
export default {
    safelist: [
        ...
        'px-8',
        'py-4',
        // Used by the rich editor custom block badges injected from resources/js/admin.js,
        // which Tailwind cannot scan for class names since they are built at runtime.
        'ms-4',
        'inline-flex',
        'items-center',
        'gap-x-2',
